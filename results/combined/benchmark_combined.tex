...
\begin{table*}[htbp]
  ...
  \begin{tabular}{@{} l l rr rrr @{}}
    ...
    \multirow{10}{*}{SmolLM2-135M}
     & BF16 & 212.3 & 1.00x & 0.1890 & 0.0553 & 0.0061 \\
     & Uniform INT8 & 106.2 & 2.00x & 0.1851 & 0.0551 & \textbf{0.0068} \\
     ...
     & \textbf{LLM-QRP} & 194.6 & 1.09x & 0.1888 & 0.0548 & 0.0060 \\
    \midrule
    \multirow{10}{*}{LFM2-350M}
     & BF16 & 392.2 & 1.00x & 0.4126 & 0.0543 & 0.0008 \\
     ...
     & SpQR (3-bit) & 102.6 & 3.82x & 0.3943 & \textbf{0.0568} & 0.0009 \\
     & SliM-LLM (2-bit) & 49.0 & 8.00x & 0.0625 & 0.0005 & 0.0003 \\
     & SmoothQuant (8-bit) & 196.1 & 2.00x & 0.4125 & 0.0537 & 0.0008 \\
     & Atom (4-bit) & 98.0 & 4.00x & 0.3597 & 0.0465 & \textbf{0.0030} \\
     & \textbf{LLM-QRP} & 214.4 & 1.83x & \textbf{0.4170} & 0.0544 & 0.0008 \\
    \midrule
    \multirow{10}{*}{Qwen2.5-0.5B}
     & BF16 & 715.7 & 1.00x & 0.4111 & 0.0727 & 0.0458 \\
     & Uniform INT8 & 357.8 & 2.00x & 0.4023 & 0.0690 & 0.0474 \\
     & Uniform INT4 & 178.9 & 4.00x & 0.3479 & 0.0678 & \textbf{0.0565} \\
     & GPTQ (4-bit) & 178.9 & 4.00x & 0.3050 & 0.0510 & 0.0272 \\
     & AWQ (4-bit) & 178.9 & 4.00x & 0.3592 & 0.0683 & 0.0406 \\
     & SpQR (3-bit) & 188.5 & 3.80x & \textbf{0.4180} & 0.0714 & 0.0478 \\
     & SliM-LLM (2-bit) & 89.5 & 8.00x & 0.0292 & 0.0001 & 0.0093 \\
     & SmoothQuant (8-bit) & 357.8 & 2.00x & 0.4097 & \textbf{0.0734} & 0.0470 \\
     & Atom (4-bit) & 178.9 & 4.00x & 0.3162 & 0.0585 & 0.0279 \\
     & \textbf{LLM-QRP} & 641.1 & 1.12x & 0.4147 & 0.0732 & 0.0456 \\
    \midrule
    \multirow{10}{*}{granite-4.0-350m}
     & BF16 & 499.1 & 1.00x & 0.2521 & 0.0477 & 0.0067 \\
     ...
     & \textbf{LLM-QRP} & 249.6 & 2.00x & \textbf{0.2562} & 0.0463 & 0.0064 \\
    \bottomrule
  \end{tabular}
\end{table*}
